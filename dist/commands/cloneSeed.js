            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        document = _a.sent();
                        if (!document.exists) {
                            console.log("No document matching this path: ".concat(collectionName, "/").concat(documentId));
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 3:
                        ...
                        data[key] = "<@db.collection('".concat(data[key]._path.segments[0], "').doc('").concat(data[key]._path.segments[1], "')@> as any");
                        return [3 /*break*/, 10];
                    case 4:
                        if (!(value &&
                            value.constructor &&
                            value.constructor.name === "Timestamp")) return [3 /*break*/, 5];
                        data[key] = "<@admin.firestore.Timestamp.fromDate(new Date('".concat(value.toDate(), "'))@> as any");
                        return [3 /*break*/, 10];
                    case 5:
                        if (!(value &&
                            value.constructor &&
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        seedContent = JSON.stringify(cleanData, null, 2)
                            ...
                            .replace(/@> as any"/g, "")
                            .replace(/@>"/g, "");
                        return [4 /*yield*/, renderSeed("".concat(seedDir, "/").concat(collectionName, "/").concat(id ? id : documentId, ".ts"), seedContent)];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                ...
                return [3 /*break*/, 5];
            case 8:
                console.log("".concat(seedsClonedCount, " seeds cloned successfully!"));
                return [2 /*return*/];
        }
    });
}); });
