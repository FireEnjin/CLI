        ...
        switch (_k.label) {
            ...
            case 4:
                ...
                for (_f = 0, _g = Object.keys(models); _f < _g.length; _f++) {
                    modelName = _g[_f];
                    importStr += "const ".concat(modelName, " = require(\"./models/").concat(modelName, "/").concat(modelName, ".model\");\n");
                }
                _k.label = 5;
            case 5:
                _k.trys.push([5, 7, , 8]);
            ...
            case 7:
                ...
                return [3 /*break*/, 8];
            case 8:
                console.log("Rendered Firebase Functions index file with ".concat(triggers.length + 1, " triggers and ").concat(endpointCount + endpoints.length, " api endpoints..."));
                return [2 /*return*/];
        }
    });
}); });
