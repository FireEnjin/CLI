...
exports.default = (function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        (0, tiny_glob_1.default)("./dist/migrations/**/*.js", { cwd: process.cwd() }).then(function (files) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        file = files_1[_i];
                        pathArr = file.split("/");
                        currentMigration = require("".concat(file.replace("./", process.cwd() + "/"))).default(db, dryRun);
                    ...
                    case 5:
                        ...
                        console.log("Running migration ".concat(migrationName, "..."));
                        result = void 0;
                        _b.label = 6;
                    case 6:
                        _b.trys.push([6, 8, , 9]);
                    ...
                    case 8:
                        error_1 = _b.sent();
                        console.log(error_1);
                        throw new Error("Error running ".concat(migrationName, " migration..."));
                    case 9:
                        if (dryRun) {
                            return [3 /*break*/, 14];
                        }
                    ...
                    case 12:
                        error_2 = _b.sent();
                        console.log(error_2);
                        throw new Error("Error saving ".concat(migrationName, " migration results..."));
                    case 13:
                    ...
                    case 14:
                        ...
                        return [3 /*break*/, 1];
                    case 15:
                        console.log("".concat(migrationCount, " migrations ran successfully!"));
                        return [2 /*return*/];
                }
            });
        }); });
